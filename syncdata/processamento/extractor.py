...
data_path = Path(__name__).parent.absolute() / "syncdata" / "datasets"
...
sinan.download(files, local_dir=data_path)
...
df_final.write_parquet(f"{data_path.parent}/data/ACGRBR.parquet")
